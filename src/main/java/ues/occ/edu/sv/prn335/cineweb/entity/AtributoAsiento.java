...
public class AtributoAsiento implements Serializable {
    ...
    @Column(name = "valor")
    private int valor;
    @JoinColumn(name = "id_asiento", referencedColumnName = "id_asiento", insertable = false, updatable = false)
    ...
    public String toString() {
        return "ues.occ.edu.sv.prn335.cineweb.entity.AtributoAsiento[ atributoAsientoPK=" + atributoAsientoPK + " ]";
    }
